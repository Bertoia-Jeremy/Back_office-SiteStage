...
?>
        <section class="container">
                <form method='POST' action="./Ressources/creation_calendrier.php" class="px-3 my-4 mx-auto text-secondary w-100">
                    ...
                    <div class="d-flex justify-content-center align-self-center">
                        <a href="./Ressources/creation_calendrier.php" class="btn btn-secondary m-3">Pas de vacances</a>  
