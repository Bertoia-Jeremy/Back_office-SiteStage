...
<div class="row mx-0 mb-4">
    <div class="col-6 text-left">
        <a href="index.php?page=8&Ajout" class="btn btn-outline-primary mx-2 align-self-start"><i class="fas fa-plus-circle"></i> Ajouter un ouvrier</a>
    </div>
    <div class="col-6 text-right">
        <a href="index.php?page=8&Vacances" class="btn btn-secondary mx-2">Créer un calendrier</a>
    </div>
</div>

<?php
    $query = "  SELECT   Identifiant, Prenom
                FROM     Guillermain_ouvriers
                ORDER BY Prenom";
