...
<?php
    ...
    if(isset($_GET['Ajout']) OR isset($_GET['Modification']) OR isset($_GET['Vacances'])){
        ...
        $query = 'DELETE FROM Guillermain_ouvriers WHERE Identifiant = :identifiant';
        ...
        $query = "  INSERT INTO Guillermain_ouvriers(   Identifiant,
                                                        Prenom) 
                    VALUES (:identifiant,
                            :prenom)";
        ...
        $query = "  UPDATE  Guillermain_ouvriers  
                    SET     Prenom      = :prenom 
